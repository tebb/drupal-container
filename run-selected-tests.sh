...
parametersHash="lsdjflsjdf" # TODO: Should be calculated.  Used to generate junit testing log file.
...
docker exec -u docker -t drupal bash -c "cd /var/www/html && /usr/bin/php7.4 '/var/www/html/vendor/phpunit/phpunit/phpunit' '--configuration' '/var/www/html/phpunit.xml.dist' '--log-junit' '/tmp/substituteparametersHashHere' '/var/www/html/web/modules/contrib/localgov_services/tests/src/FunctionalJavascript/ServicesMenuGroupTest.php'"
